class Form
  ...
  def save
    SendingDestination.create(post_code: post_code, prefecture_code_id: prefecture_code_id, city: city, house_number: house_number, bilding_number: bilding_number,phone_number: phone_number)
    # 寄付金の情報を保存
